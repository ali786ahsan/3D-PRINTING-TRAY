...
if len(sys.argv)>1:
    dev1=sys.argv[1]
    print('using command line arg 1, and provided device! [{0}]'.format(dev1))
...
print('using devName=[{0}]'.format(devName)) # devName=[ttyUSB2]
...
# while False:
    ...
    nBytes=file.write(dateStr1 + dataStr1 + "\n")
    file.flush()
